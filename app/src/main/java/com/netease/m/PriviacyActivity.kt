...
import com.netease.m.databinding.ActivityPriviacyBinding
...
class PriviacyActivity : AppCompatActivity() {
    ...
    lateinit var bind: ActivityPriviacyBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityPriviacyBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.netease.m"

        val myId: String? = Hawk.get(AppClass.MYID, "null")
        val instanceId: String? = Hawk.get(AppClass.INSTID, "null")
        val main: String? = sharPref.getString(AppClass.C1, null)
        Log.d("TESTAG", "Test Result $main")
...
//        val three = "sub_id_3="
        ...
        val first = "http://"
        val second = "royalallure.xyz/go.php?to=2&"
